class Slider extends Entity{
    constructor(options) {
        ...
        this.sliderButton = new Button({scale: [settings.scale[1], settings.scale[1]],x: settings.x,y: settings.y,roundness: 0.5,color: settings.button_color,draggable: true,lock_y: true});
